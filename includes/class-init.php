...
final class Init {
	...
	private function dependencies() {
		...
		require_once UBM_PATH . 'admin/class-admin.php';

		// Frontend functionality, scripts and styles.
		require_once UBM_PATH . 'frontend/class-frontend.php';

		// Translation functionality.
		require_once UBM_PATH . 'includes/class-i18n.php';
	...
	public function plugin_support() {
		...
		if ( upm_acf() ) {
			include_once UBM_PATH . 'includes/acf/class-extend-acf.php';
		}

		// Add Beaver Builder support.
		if ( class_exists( 'FLBuilder' ) ) {
			include_once UBM_PATH . 'includes/beaver/class-beaver-builder.php';
		}

		// Add Elementor support.
		if ( class_exists( '\Elementor\Plugin' ) ) {
			include_once UBM_PATH . 'includes/elementor/class-elementor.php';
		}
